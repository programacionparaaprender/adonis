...
Route.group(() => {
  Route.post('usuarios/InsertarActualizarUsuarios', 'UserController.InsertarActualizarUsuarios');
  ...
  Route.post('proyectos2', 'ProyectoController.createProyecto');
  Route.get('proyectos2', 'ProyectoController.obtenerProyectos');
